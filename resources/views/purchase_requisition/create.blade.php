	...
	@component('components.widget', ['class' => 'box-solid'])
		...
		<div class="col-sm-4 text-left"></div>
			<div class="col-sm-4 text-left">
				{!! Form::label('date', __('رقم أمر البيع') . ':') !!}
				{!! Form::text('sale_order_ref_no', null, ['class' => 'form-control ','id'=>'sale_order_ref_no']); !!}
				...
				<table class="table" id="products_list">
					<thead>
						<tr>
							...
							<th width="35%">الكمية المراد شرائها</th>
		...
		$(document).ready( function(){
            ...
            $('#show_pr_products').click( function(){
            	...
            	var data = {
	            	...
	            	brand_id: $('#brand_id').val(),
	            	category_id: $('#category_id').val(),
					sale_order_ref_no: $('#sale_order_ref_no').val(),
	            }
