...
class ProductUtil extends Util
{
     ...
     * @return bool
     */
    public function decreaseProductQuantity($product_id, $variation_id, $location_id, $new_quantity, $old_quantity = 0,$qty_reserved = 0)   
    {
        $qty_difference = $new_quantity - $old_quantity;
        ...
        if ($product->enable_stock == 1) {
            ...
            $details->increment('qty_reserved', $qty_reserved);
        }
...
//                ->where('variations.id', $variation_id);
    ...
    public function getProductStockDetails($business_id, $filters, $for)
    {
        ...
        $products = $query->select(
            ...
            DB::raw('SUM(vld.qty_reserved) as qty_reserved'),
