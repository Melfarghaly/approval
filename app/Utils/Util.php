...
class Util
{
    ...
    {
        //dd($on, $action, $before, $properties, $log_changes, $business_id);
        if ($log_changes) {
    ...
    public function fy_check($business_id,$transaction_date){
        $business=Business::find($business_id);
        $transaction_date = date('Y-m-d', strtotime($transaction_date));
        $start_date = date('Y-m-d', strtotime($business->fy_start_date));
        $end_date = date('Y-m-d', strtotime($business->fy_end_date));
